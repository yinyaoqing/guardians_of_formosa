...
**M1 沒有美術前置條件。** 早先「美術風格須先定案」的判斷已撤回——M1 全程在灰盒（純色塊）上開發，美術改為並行軌道，兩軌在 M1 收尾時匯合。理由見 `2026-09-04-visual-polish-pipeline.md` §4：塔防的樂趣完全來自數值、路徑與節奏，美術先行的後果是玩法一改資產全部作廢，而這在垂直切片階段必然發生。美術軌的里程碑見 `2026-09-04-art-direction-bible.md` §8。
